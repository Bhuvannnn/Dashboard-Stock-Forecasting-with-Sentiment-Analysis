...
<body>
				...
				<div class="content-wrapper">
					...
					<div class="card-body">
						<div class="row" class="card-body">
							<iframe src="http://localhost:8502" width="1200" height="1200"></iframe>
						</div>
					</div>
					<!-- Footer -->
	...
	<script src="adminResources/js/customizer.js"></script>
	<script
		src="adminResources/js/perfect-scrollbar.js"></script>
