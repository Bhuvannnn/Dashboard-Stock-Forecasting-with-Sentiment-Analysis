			...
			<div class="authentication-inner">
				...
				<div class="card">
					<div class="card-body">
						...
						<!-- /Logo -->
						<h4 class="mb-2"><a href="index.jsp" class="app-brand-link gap-2">Welcome to Prompt Softech</a></h4>
						<p class="mb-4">Please sign-in to your account and start the
							Day</p>

						<form id="formAuthentication" class="mb-3" action="verify.jsp"
							method="POST">
							<div class="mb-3">
								<label for="email" class="form-label">Email or Username</label>
								<input type="text" class="form-control" id="email"
									name="un" placeholder="Enter your email or username"
									autofocus />
							</div>
						...
						<p class="text-center">
							<span>Don't have an account?</span> <a href="register.jsp"> <span>Sign
									up instead</span>
							</a>
						</p>
					</div>
